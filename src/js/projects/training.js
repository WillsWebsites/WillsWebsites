    ...
    $('.training-item').click(function (e) {
      ...
      switch (true) {
        ...
        case $(e.target).closest('.training-item').hasClass('country-finder'):
          modalContentHandler(
            'Country Finder',
            [`An informational application to view data on the country you're in or a country you choose to search`, `A sample country with some data about the country is loaded in view to start. To search for that same information about the current country you're in, utilize the "Where am I?" box. To search for data on a specific country of your choice, utilize the "Search a Country" box.`, `How to deal with AJAX calls to an external API and handle both resolved and rejected promises. Also focused on handling user input to search for external data and ultimately have that data displayed to the DOM`],
            'country-finder',
