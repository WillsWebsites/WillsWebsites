  ...
  const projectsList = [
    {
      ...
      desktopImg: new URL("../img/projects/desktop/gt.jpg", import.meta.url),
      mobileImg: new URL(
        "../img/projects/mobile/gt-mobile.jpg",
        import.meta.url
      ),
    ...
    },
    {
      ...
      desktopImg: new URL(
        "../img/projects/desktop/concordia.jpg",
        import.meta.url
      ),
      mobileImg: new URL(
        "../img/projects/mobile/concordia-mobile.jpg",
        import.meta.url
      ),
      logo: new URL(
    ...
    },
    {
      ...
      desktopImg: new URL(
        "../img/projects/desktop/concord.jpg",
        import.meta.url
      ),
      mobileImg: new URL(
        "../img/projects/mobile/concord-mobile.jpg",
        import.meta.url
      ),
    ...
    },
    {
      ...
      desktopImg: new URL(
        "../img/projects/desktop/nestegg.jpg",
        import.meta.url
      ),
      mobileImg: new URL(
        "../img/projects/mobile/nestegg-mobile.jpg",
        import.meta.url
      ),
    ...
    },
    {
      ...
      desktopImg: new URL(
        "../img/projects/desktop/hartwell.jpg",
        import.meta.url
      ),
      mobileImg: new URL(
        "../img/projects/mobile/hartwell-mobile.jpg",
        import.meta.url
      ),
    ...
    },
    {
      ...
      desktopImg: new URL("../img/projects/desktop/rhino.jpg", import.meta.url),
      mobileImg: new URL(
        "../img/projects/mobile/rhino-mobile.jpg",
        import.meta.url
      ),
    ...
    },
    {
      ...
      desktopImg: new URL(
        "../img/projects/desktop/hemlock.jpg",
        import.meta.url
      ),
      mobileImg: new URL(
        "../img/projects/mobile/hemlock-mobile.jpg",
        import.meta.url
      ),
    ...
    },
    {
      ...
      desktopImg: new URL(
        "../img/projects/desktop/xcountry.jpg",
        import.meta.url
      ),
      mobileImg: new URL(
        "../img/projects/mobile/xcountry-mobile.jpg",
        import.meta.url
      ),
